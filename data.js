...
module.exports.ROOMS = {
    ...
    LIFFOutside: {
        ...
        areaColors: {
            ...
            h7fffb8: { cmd: "text", label: "Greeter", txt: "Welcome to LIFF!", align: "center", lines: 1, point: [120, 150] },
        },
        things: {
            greeter: { file: "museumGuard.png", frames: 1, frameDelay: 30, position: [120, 150], label: "Greeter" }
