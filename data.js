...
module.exports.ROOMS = {
    ...
    LIFFLobby: {
        ...
        areaColors: {
            ...
            h35e5ba: { cmd: "text", url: "https://shop.liff.nl/", label: "Audience scores", txt: "Click or Tap on this box to check out the\nTOP 10 LIFF Films\nbased on audience scores.", align: "center", lines: 2, point: [128, 106]},
        ...
        things: {
            ...
            lobbyperson1: { file: "medewerker2.png", frames: 1, frameDelay: 10, position: [10, 70], label: "LIFF Personel", command: { cmd: "text", txt: "Ssssht, there are movie trailers playing in this room. Please be quiet when you enter.", align: "center", lines: 5, point: [22, 88] } },
            lobbyperson2: { file: "medewerker5.png", frames: 1, frameDelay: 10, position: [192, 37], label: "LIFF Personel", command: { cmd: "text", txt: "There is a super underground indie movie premiering in this room, a chance of a life-time!", align: "center", lines: 5, point: [204, 55] }},
            infoperson: { file: "medewerker6.png", frames: 30, frameDelay: 8, position: [156, 166], label: "Kasper the friendly Host", command: { cmd: "text", txt: "Hi, welcome to the LIFF online hub, I'm so glad you're visiting! Here you can walk around and talk to other film-fanatics. Don't forget to check out the merch, food, or theater rooms. Enjoy!", align: "center", lines: 8, point: [154, 184] } },
