...
function update() {
    ...
    //renders the avatar selection screen which can be fully within the canvas
        ...
        text("Choose your avatar", WIDTH / 2, 28 * ASSET_SCALE);
...
function avatarSelection() {
    ...
    previousColor = createSprite(175 * ASSET_SCALE + 14, HEIGHT / 2 + 14);
    ...
    nextColor = createSprite(191 * ASSET_SCALE + 14, HEIGHT / 2 + 14);
