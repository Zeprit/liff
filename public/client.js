...
var descripText = ["This half tower, half human is at LIFF to make some new friends.\nFavourite movie is Metropolis because of\n'the amazing acting roles the skyscrapers had.'",
                  "I'll tell you one thing, don't bring the tuba.",
                  "They were afraid people would notice they were an Alien,\nbut it turns out everyone at the festival looks a bit non-human.",
                  "Best archer in the world who snuck away from their oppressive\nhero-family to check out the newest movies at the festival.",
                  "Hasn't taken off their roller skates for years.\n'I hope there are elevators. I heard an alien movie was playing upstairs'",
                  "A prince from the planet crocky, here to settle unfinished business\nwith another prince at the festival...",
                  "An experiment gone wrong, escaped the lab to visit\nthe film festival, and is hoping to see a sequel to Flubber.",
                  "This dragon got their neck broken in a weird accident.\nTo disguise they are a dragon, they're wearing a hoodie.",
                  "It's their birthday but no one showed up.\nThey brought their own chair because they get tired very quickly\nbecause of very small legs.",
                  "Is it an astronaut, is it a robot?\nEven they do not know. Came to LIFF to pitch their movie idea \n'Robots in Space'",
                  "Starred in over a dozen films but never got any credit for them.",
                  "They spend most days at the gym so\nthat everyone at the film festival would recognize\ntheir great muscles. (Might not fit through the front door)",
                  "Wants to have friends, but their skin is super.. prickly\nSince they can't hug, they find comfort in romantic movies.\nFavorite movie: Edward Scissorhands",
                  "Surprisingly, this creepy creature only watches feel-good films.\nAlso here voluntarily to guide someone through the river Styx,\nshould they choke on a popcorn kernel...",
                  "Invented the pirate word 'Arrr' when they stubbed their bony toe.\nNow used by pirates all around.",
                  "They heard there was popcorn, the only ingredient\nmissing from their witches brew.\n(aside from human eyeballs, but let's not discuss that here…)",
                  "They're a year late to the festival but better late than never.",
                  "It's just a regular, normal, ordinary, unremarkable plant.\nOr is it...",
                  "Discovered that rolling is way faster than crawling.\nThey hope to run into a director who makes those fast car movies.",
                  "Just someone in a green cape. Thinks they're brilliant\nbecause they're wearing a cape to LIFF and at the same\ntime feel out of place and unsure about the choice.",
                  "Is a bit late for the festival since they had to travel all the way\nfrom the deepest part of the forest. Not quite used\nto electronic lights yet, so they carry a lantern around everywhere.",
                  "Likes watching movies with some wine and cheese in a dark,\ncandle-lit room.",
                  "I don't get why people say 'why the long face?'.\nThe bigger the face, the wider the smile, I tell them.",
                  "This ghost forgot to take its long blanket to the festival,\nbut that doesn't matter.\nThe sheer excitement of being at LIFF makes them able to fly.",
                  "'I heard they give away prizes for the best movies.\nDo they also give prizes to regular visitors?\nIf they do, I need one!'",
                  "Only here to avoid the cold weather but secretly hopes to see Spiderman,\nor any spider-ey person for that matter.",
                  "They are here to see some action. Hopefully they won't have an\nendless fight with another prince about why they are the best prince,\njust like last year at LIFF...",
                  "Thinks violence and blood in movies are really gross.\nThey'd rather see some comedy films.",
                  "Loves those movies where the monster turns out to be the hero.\nMonsters should get a better rep, you know...",
                  "This world is made for people with their head on the top,\nnot the bottom. Going to the movies makes that\npainfully clear. Every time...",
                  "Wants to be friends with a certain famous archeologist,\nbut they lost contact after some weird dispute over a lost ark in Tanis.\nHopes to find him at the Leiden International Film Festival.",
                  "'I may look like an ant-eater,\nbut I swear to god that I'm not one of them.\nSpeaking of which, do they also sell ant-related snacks here?'",
                  "'LIFF is like an all you can eat popcorn event.\nWhen people spill their popcorn, I'll be the one to catch\nit with my mouth, just before it hits the ground! DELICIOUS!'",
                  "A very friendly fly who likes lighthearted comedies.\nWill even light the theater rooms if needed.\nThey don't even work for LIFF, how sweet.",
        ...
        try {
            ...
            if (me == null) {
                ...
                if (ROOMS[SETTINGS.defaultRoom].spawn == null) {
                    ...
                    //var sx = round(10 * ASSET_SCALE, 128 * ASSET_SCALE));
                    //var sy = round(70 * ASSET_SCALE, 100 * ASSET_SCALE));
